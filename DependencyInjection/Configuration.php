...
namespace PhpMob\RestBundle\DependencyInjection;

use PhpMob\RestBundle\Form\Type\ClientType;
use PhpMob\RestBundle\Model\AccessToken;
use PhpMob\RestBundle\Model\AccessTokenInterface;
use PhpMob\RestBundle\Model\AuthCode;
use PhpMob\RestBundle\Model\AuthCodeInterface;
use PhpMob\RestBundle\Model\Client;
use PhpMob\RestBundle\Model\ClientInterface;
use PhpMob\RestBundle\Model\RefreshToken;
use PhpMob\RestBundle\Model\RefreshTokenInterface;
use PhpMob\RestBundle\Model\UserInterface;
...
final class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode = $treeBuilder->root('phpmob_rest');
